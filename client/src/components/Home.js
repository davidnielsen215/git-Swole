...
class Home extends Component {
    ...
    render() {
        ...
        return (
            <div style={{backgroundImage:`url(https://images.unsplash.com/photo-1560263492-df02cac7762c?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=976&q=80)`}}>

    ...
    render(){
        return (
            <Provider value={{
                ...
                handleGettriWorkout: this.handleGetTri,
                handleGettriWorkout2: this.handleGetTri2,
                handleGettriWorkout3: this.handleGetTri3,
                handleGettriWorkout4: this.handleGetTri4,
                handleGetshoulderWorkout: this.handleGetShoulder,
                handleGetshoulderWorkout2: this.handleGetShoulder2,
                handleGetshoulderWorkout3: this.handleGetShoulder3,
                handleGetshoulderWorkout4: this.handleGetShoulder4,
                handleGetshoulderWorkout5: this.handleGetShoulder5,
                handleGetforearmsWorkout: this.handleGetForearms,
                handleGetforearmsWorkout2: this.handleGetForearms2,
                handleGetforearmsWorkout3: this.handleGetForearms3,
                handleGetforearmsWorkout4: this.handleGetForearms4,
                handleGetcoreWorkout: this.handleGetCore,
                handleGetcoreWorkout2: this.handleGetCore2,
                handleGetcoreWorkout3: this.handleGetCore3,
                handleGetcoreWorkout4: this.handleGetCore4,
                handleGetcoreWorkout5: this.handleGetCore5,
                handleGetlegsWorkout: this.handleGetLegs,
                handleGetlegsWorkout2: this.handleGetLegs2,
                handleGetlhandleGetegsWorkout3: this.handleGetLegs3,
                handleGetlegsWorkout4: this.handleGetLegs4,
